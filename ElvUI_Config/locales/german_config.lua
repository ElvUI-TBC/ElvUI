...
L["Scroll Direction"] = "Scroll-Richtung"
...
L["Make the unitframe glow yellow when it is below this percent of health, it will glow red when the health value is half of this value."] = "Lässt das Einheitenfenster gelb leuchten, wenn es unter diesen Prozentwert des Lebens sinkt. Es wird Rot angezeigt, wenn es die Hälfte dieses Wertes erreicht."
L["NamePlates"] = "Namensplaketten"
L["Nameplate Motion Type"] = "Namensplaketten Bewegungsart"
L["Non-Target Transparency"] = "Transparenz nicht ausgewählter Ziele"
L["Overlapping Nameplates"] = "Überlappende Namensplaketten"
...
L["Stacking Nameplates"] = "Stapelnde Namensplaketten"
...
L["Block Raid Buffs"] = "Blockiere Raid-Buffs"
...
L["Don't display auras that cannot be purged or dispelled by your class."] = "Zeige keine Auren, die nicht von deiner Klasse gereinigt oder gebannt werden können."
L["Don't display auras that have no duration."] = "Zeige keine Auren, die keine Laufzeit haben."
L["Don't display raid buffs such as Blessing of Kings or Mark of the Wild."] = "Zeige keine Raid-Buffs wie Segen der Könige oder Mal der Wildnis"
L["Down"] = "Hinunter"
...
L["Others"] = "Andere"
L["Overlay the healthbar"] = "Überlagerung der Gesundheitsleiste"
