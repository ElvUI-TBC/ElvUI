...
function S:LoadTabardSkin()
	...
	hooksecurefunc(TabardCharacterModelRotateLeftButton, "Point", function(self, point, _, _, xOffset, yOffset)
		if(point ~= "BOTTOMLEFT" or xOffset ~= 4 or yOffset ~= 4)then
			self:Point("BOTTOMLEFT", 4, 4)
		end
	end)

	hooksecurefunc(TabardCharacterModelRotateRightButton, "Point", function(self, point, _, _, xOffset, yOffset)
