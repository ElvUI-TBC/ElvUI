...
local function dragdrop_OnMouseUp(frame, ...)
	if frame.obj.dragOnMouseUp then
		...
		GameTooltip:Hide()
		dragdropButton:Hide()
		if dragdropButton.enteredFrame and dragdropButton.enteredFrame ~= frame and MouseIsOver(dragdropButton.enteredFrame) then
...
local function Constructor()
	...
	frame:HookScript2("OnClick", dragdrop_OnClick)
	frame:HookScript2("OnEnter", dragdrop_OnEnter)
	frame:HookScript2("OnLeave", dragdrop_OnLeave)
	frame:HookScript2("OnMouseUp", dragdrop_OnMouseUp)
	frame:HookScript2("OnMouseDown", dragdrop_OnMouseDown)
