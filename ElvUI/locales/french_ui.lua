...
--*_MSG locales
L["LOGIN_MSG"] = "Welcome to %sElvUI|r version %s%s|r, type /ec to access the in-game configuration menu. If you are in need of technical support you can visit us at https://github.com/ElvUI-TBC/ElvUI or join our Discord: https://discord.gg/Uatdmm7"
...
L["HPS"] = "HPS"
L["lvl"] = "niveau"
L["Miss Chance"] = "Risques de rater"
...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/ElvUI-TBC/ElvUI"] = "Vous avez maintenant terminé le processus d'installation. Si vous avez besoin d'un support technique, merci de vous rendre sur https://github.com/ElvUI-TBC/ElvUI"
...
L["Detected that your ElvUI Config addon is out of date. Not having your ElvUI Config addon up to date will result in missing options."] = "Nous avons détecté que votre installation d'ElvUI est périmée. Ne pas avoir la version à jour ElvUI peut entrainer des erreurs."
...
L["ElvUI is five or more revisions out of date. You can download the newest version from https://github.com/ElvUI-TBC/ElvUI/"] = "ElvUI est périmé d'au moins 5 versions. Vous pouvez télécharger la nouvelle version sur https://github.com/ElvUI-TBC/ElvUI/"
L["ElvUI is out of date. You can download the newest version from https://github.com/ElvUI-TBC/ElvUI/"] = "ElvUI est périmé. Vous pouvez télécharger la nouvelle version sur https://github.com/ElvUI-TBC/ElvUI/"
...
L["For technical support visit us at https://github.com/ElvUI-TBC/ElvUI"] = "Pour tout support technique, merci de nous visiter à https://github.com/ElvUI-TBC/ElvUI"
