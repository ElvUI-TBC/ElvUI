...
function TT:Initialize()
	...
	GameTooltipStatusBar:SetScript("OnValueChanged", TT.OnValueChanged)
	GameTooltipStatusBar:ClearAllPoints()
	...
	GameTooltipStatusBar.text:Point("CENTER", GameTooltipStatusBar, 0, -3)
	GameTooltipStatusBar.text:FontTemplate(E.LSM:Fetch("font", TT.db.healthBar.font), TT.db.healthBar.fontSize, TT.db.healthBar.fontOutline)
	...
	TT:HookScript(GameTooltip, "OnSizeChanged", "CheckBackdropColor")

	TT:HookScript(GameTooltipStatusBar, "OnValueChanged", "GameTooltipStatusBar_OnValueChanged")
	...
	for _, tt in pairs(tooltips) do
		TT:HookScript(tt, "OnShow", "SetStyle")
	end
