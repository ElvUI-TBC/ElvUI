...
--*_MSG locales
L["LOGIN_MSG"] = "Добро пожаловать в %sElvUI|r версии %s%s|r, наберите /ec для доступа в меню настроек. Если Вам нужна техническая поддержка, посетите наш форум на https://github.com/ElvUI-TBC/ElvUI или присоединяйтесь к серверу Discord: https://discord.gg/Uatdmm7"
...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/ElvUI-TBC/ElvUI"] = "Вы завершили процесс установки. Если Вам требуется техническая поддержка, посетите https://github.com/ElvUI-TBC/ElvUI"
...
L["Detected that your ElvUI Config addon is out of date. Not having your ElvUI Config addon up to date will result in missing options."] = "Мы обнаружили, что ElvUI Config устарел. Устаревший ElvUI Config может привести к отсутствию некоторых опций."
...
L["For technical support visit us at https://github.com/ElvUI-TBC/ElvUI"] = "За технической поддержкой обращайтесь на https://github.com/ElvUI-TBC/ElvUI"
