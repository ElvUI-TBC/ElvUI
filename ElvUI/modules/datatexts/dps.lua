...
DT:RegisterDatatext("DPS", {"PLAYER_LOGIN", "COMBAT_LOG_EVENT_UNFILTERED", "PLAYER_LEAVE_COMBAT", "PLAYER_REGEN_DISABLED", "UNIT_PET"}, OnEvent, nil, OnClick, nil, nil, STAT_DPS_SHORT)