...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/ElvUI-TBC/ElvUI"] = "已完成安裝程序. 小提示: 若想開啟微型選單, 請在小地圖按滑鼠中鍵. 如果沒有中鍵按鈕, 請按住Shift鍵, 並在小地圖按滑鼠右鍵. 如需技術支援請至 https://github.com/ElvUI-TBC/ElvUI"
...
L["ElvUI is five or more revisions out of date. You can download the newest version from https://github.com/ElvUI-TBC/ElvUI/"] = "ElvUI 以過期超過5個版本. 你可以在 https://github.com/ElvUI-TBC/ElvUI/ 下載到最新的版本."
L["ElvUI is out of date. You can download the newest version from https://github.com/ElvUI-TBC/ElvUI/"] = "ElvUI 以過期. 你可以在 https://github.com/ElvUI-TBC/ElvUI/ 下載到最新的版本."
...
L["For technical support visit us at https://github.com/ElvUI-TBC/ElvUI"] = "如需技術支援請至 https://github.com/ElvUI-TBC/ElvUI"
