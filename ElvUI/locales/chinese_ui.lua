...
--*_MSG locales
L["LOGIN_MSG"] = "欢迎使用 %sElvUI|r %s%s|r 版, 请输入/ec进入设定介面. 如需技术支持,请至至 https://github.com/ElvUI-TBC/ElvUI"
...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/ElvUI-TBC/ElvUI"] = "你已经完成安装过程. 如果你需要技术支持请访问 https://github.com/ElvUI-TBC/ElvUI"
...
L["For technical support visit us at https://github.com/ElvUI-TBC/ElvUI"] = "如需技术支援请至 https://github.com/ElvUI-TBC/ElvUI"
